...
SECRET_KEY = 'django-insecure-@ld%#(bgl+ecyhr&xlr60h8!spxjn&_@6w$e8y+1in4a*lm6pl'
DEBUG = True
ALLOWED_HOSTS = []
...
# Place the print statement outside of the dictionary
print("REST Framework settings:", REST_FRAMEWORK)
